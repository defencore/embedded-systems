...
* /path/toolchain-mips_34kc_gcc-4.8-linaro_uClibc-0.9.33.2/bin/mips-openwrt-linux-uclibc-gcc -static random_imei_generator.c -o random_imei_generator
*
* ./random_imei_generator
*
*/
